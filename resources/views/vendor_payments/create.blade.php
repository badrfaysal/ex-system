...
@section('header_title', $isAr ? 'تسجيل سند دفع' : 'Record Vendor Payment')
...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex justify-between items-center animate-fade-in">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-2xl font-bold text-gray-900">{{ $isAr ? 'تسجيل سند دفع لمورد' : 'Record Vendor Payment' }}</h2>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 animate-fade-in">
        ...
        @include('vendor_payments._form', ['payment' => null])
    </div>
</div>
@endsection
